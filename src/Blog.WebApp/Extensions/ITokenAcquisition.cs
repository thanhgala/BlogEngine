...
namespace Microsoft.AspNetCore.Authentication
{
    public interface ITokenAcquisition
    {
        ...
        /// </code>
        /// </example>
        Task AddAccountToCacheFromJwt(JwtBearer.TokenValidatedContext tokenValidationContext, IEnumerable<string> scopes = null);
        ...
        /// </code>
        /// </example>
        Task AddAccountToCacheFromJwt(TokenValidatedContext tokenValidationContext, IEnumerable<string> scopes = null);
