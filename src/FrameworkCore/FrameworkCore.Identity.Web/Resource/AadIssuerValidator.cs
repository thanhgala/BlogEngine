...
using System.Linq;
using FrameworkCore.Identity.Web.InstanceDiscovery;
using Microsoft.IdentityModel.JsonWebTokens;

namespace FrameworkCore.Identity.Web.Resource
{
    /// <summary>
    ...
    public class AadIssuerValidator
    {
        ...
        public string Validate(string actualIssuer, SecurityToken securityToken, TokenValidationParameters validationParameters)
        {
            ...
            if (validationParameters.ValidIssuers != null)
                if (validationParameters.ValidIssuers.Any(validIssuerTemplate => IsValidIssuer(validIssuerTemplate, tenantId, actualIssuer)))
                {
                    return actualIssuer;
                }
