...
using FrameworkCore.Mapper.Models;
using FrameworkCore.Utils.ActionUtils;
using FrameworkCore.Utils.AssemblyUtils;
using FrameworkCore.Utils.Attributes;
using FrameworkCore.Utils.TypeUtils;

namespace FrameworkCore.Mapper
{
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddAutoMapperCore(this IServiceCollection services)
        {
            return services.AddAutoMapperCore(_ => { });
        }
        ...
        /// <returns></returns>
        public static IServiceCollection AddAutoMapperCore(this IServiceCollection services, [NotNull]AutoMapperCoreOptions configure)
        {
            return services.AddAutoMapperCore(_ =>
            {
        ...
        /// <param name="configure"></param>
        /// <returns></returns>
        public static IServiceCollection AddAutoMapperCore(this IServiceCollection services, [NotNull]Action<AutoMapperCoreOptions> configure)
        {
