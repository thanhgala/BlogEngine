...
namespace FrameworkCore.Web.AzureIdentity.Client
{
    ...
    public interface ITokenAcquisition
    {
        ...
        /// </code>
        /// </example>
        Task AddAccountToCacheFromJwtAsync(Microsoft.AspNetCore.Authentication.JwtBearer.TokenValidatedContext tokenValidationContext, IEnumerable<string> scopes = null);
