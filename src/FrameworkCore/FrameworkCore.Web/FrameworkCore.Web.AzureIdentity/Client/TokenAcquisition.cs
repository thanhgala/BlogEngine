...
using FrameworkCore.Web.AzureIdentity.Client.TokenCacheProviders;
using Microsoft.Extensions.Options;

namespace FrameworkCore.Web.AzureIdentity.Client
{
    /// <summary>
    ...
    public class TokenAcquisition : ITokenAcquisition
    {
        ...
        /// </code>
        /// </example>
        public Task AddAccountToCacheFromJwtAsync(TokenValidatedContext tokenValidatedContext, IEnumerable<string> scopes = null)
        {
            if (tokenValidatedContext == null)
            {
                throw new ArgumentNullException(nameof(tokenValidatedContext));
        ...
        {
            return application ??= BuildConfidentialClientApplication();
        }
